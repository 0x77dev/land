# Vendored from https://github.com/wwmoraes/dotfiles/blob/763f129b7f516a7485a52559916c724b0bc96474/modules/nix-darwin/system/pmset.nix
# at commit 763f129b7f516a7485a52559916c724b0bc96474; locally adds standby, lowpowermode, and tcpkeepalive.
{
  config,
  lib,
  ...
...
let
  ...
  commonOptions = {
    ...
    lowpowermode = mkOption {
      ...
      default = null;
      description = "enable/disable low power mode";
    };
    tcpkeepalive = mkOption {
      ...
      default = null;
      description = "enable/disable TCP keepalive during system sleep";
    };
  };
  writePmset =
    flag: entries:
  ...
  pmsetSettingsToList =
    attrs:
    lib.mapAttrsToList (k: v: "${k} ${builtins.toString v}") (lib.filterAttrs (_: v: v != null) attrs);
