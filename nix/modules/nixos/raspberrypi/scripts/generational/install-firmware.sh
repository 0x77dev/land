...
# shellcheck disable=SC2034,SC2239,SC3030,SC3043,SC3044,SC3054
...
generationPath=         # Path to nixos configuration/generation (unused but kept for interface compatibility)
